...
<div id="logo" class="mr-lg-5 top-space">
    <a href="index.php" class="standard-logo" data-dark-logo="elements/logo/Interieur_By_erdem_Logo.png">
        <img src="elements/logo/Interieur_By_erdem_Logo.png" alt="Interieur By Erdem Logo">
    </a>
    <a href="index.php" class="retina-logo" data-dark-logo="elements/logo/Interieur_By_erdem_Logo.png">
        <img src="elements/logo/Interieur_By_erdem_Logo.png" alt="Interieur By Erdem Logo">
    </a>
</div><!-- #logo end -->
